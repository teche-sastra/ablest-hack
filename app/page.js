...
export default function Home() {
  ...
  return (
    <>
      <div className='font-sans'>
        <nav className="bg-white shadow-md p-4 s md:flex flex-row justify-between items-center relative z-0">
          <div className="flex flex-row justify-between">
            <Image className='md:w-72 w-48' src={tbi} />
            <span className="md:hidden block cursor-pointer"><button onClick={() => setopen(!open)}  ><Image className="w-8" src={ham} /></button></span>
          </div>



          <ul className={`top-16 transition-all ease-in duration-300 ${open ? 'opacity-0 md:opacity-100' : ''}   md:py-0 py-4 pl-7 md:pl-0 w-full md:w-auto left-0 md:flex flex-row md:items-center  z-[-1] md:z-auto md:static absolute bg-white md:bg-transparent`}>
            <li className="mx-4 md:my-0 my-6 cursor-pointer hover:text-orange-600">About</li>
            <li className="mx-4 md:my-0 my-6 cursor-pointer hover:text-orange-600">Eligibility</li>
            <li className="mx-4 md:my-0 my-6 cursor-pointer hover:text-orange-600">Idea/Themes</li>
            <li className="mx-4 md:my-0 my-6 cursor-pointer hover:text-orange-600">Date/Awards</li>
        ...
        <div className='flex flex-col justify-center item-center md:flex-row sm:px-4 md:pt-8 md:px-12  mt-8'>
        ...
        <div className='flex flex-col bg-gray-100 space-y-0  justify-center items-center p-4'>
          <div className='lg:text-4xl font-bold text-3xl md:text-3xl'>About</div>
          <Image className='w-72' src={abt} />
          <div className='md:w-3/5 text-xl md:text-2xl'>We are welcoming submissions for theme-based concepts in the "Nutrition Hackathon 2023," calling upon Students, Research Scholars, Faculty, and Innovators from across India to participate.
        ...
        <div className='flex flex-col mt-4 space-y-0  justify-center items-center p-4'>
          <div className='lg:text-4xl font-bold text-3xl md:text-3xl'>Eligibility</div>
          <Image className='w-72' src={el} />
          <div className='md:w-3/5 text-xl text-center md:text-2xl'>Students, Research Scholars, Faculties & Innovators
        ...
        {/* ideas */}
        <div className='mt-8 flex space-y-4 flex-col justify-center items-center md:pb-12 pb-8 pt-4 mx-2 bg-gray-100'>
        ...
        <div className='flex flex-col mt-12 justify-center items-center space-y-12 pb-12  md:m-0 bg-gradient-to-tl from-amber-300'>
        <div className='text-center text-4xl mt-12 font-bold'>Dates And Awards</div>
          ...
          <div className='md:w-1/4 relative top-8 md:left-12'>
            ...
            <div className='shadow-lg md:w-3/5 flex flex-col bg-amber-400 p-6 rounded-xl text-white'>
              ...
              <div className='text-xl w-3/4'>The two most outstanding team ideas will be awarded a cash prize of Rs. 25,000 each by Janonam Natural Nutrition.</div>
            </div>
        ...
        <div className='flex md:flex-row flex-col flex-wrap justify-evenly space-y-4 p-4'>
            <Image src={sas} />
            <Image src={tbi} />
            <Image src={jana} />
        </div>
      ...
      <div className="flex flex-row justify-center bg-gray-800 text-gray-400 p-8 md:pl-40 md:pr-40">
        <div>Designed and developed by Tech-E</div>
